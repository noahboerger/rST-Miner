...
class ImplicitResult {
  constructor(implicitPlace, substitutePlace = undefined) {
    this.implicitPlace = implicitPlace;
    this.substitutePlace = substitutePlace;
  }
...
class TemplateArc {
  constructor(_source, _destination, _weight) {
  ...
  buildArcForPlace(place) {
    if (this._source != null) {
      ...
      return new _models_petri_net_arc__WEBPACK_IMPORTED_MODULE_0__.Arc(arcId, this._source, place, this._weight);
    } else if (this._destination != null) {
      const arcId = 'o' + place.id + this._destination.label;
      return new _models_petri_net_arc__WEBPACK_IMPORTED_MODULE_0__.Arc(arcId, place, this._destination, this._weight);
    }
...
class TemplatePlace {
  constructor(_marking, _unconnectedIngoingTemplateArcs = [], _unconnectedOutgoingTemplateArcs = []) {
    this._marking = _marking;
    this._unconnectedIngoingTemplateArcs = _unconnectedIngoingTemplateArcs;
    this._unconnectedOutgoingTemplateArcs = _unconnectedOutgoingTemplateArcs;
  }

  buildPlaceWithId(id) {
    const place = new _models_petri_net_place__WEBPACK_IMPORTED_MODULE_0__.Place(this._marking, id);
...
class ImplicitPlaceIdentifier {
  constructor(_transitions, _uniqueTraces) {
    ...
    this._uniqueTraces = _uniqueTraces; // TODO -> Use partial orders instead?!
  }
    ...
    for (const relatedPlace of relatedPlaces) {
      switch (this.testRelation(currentPlace, relatedPlace)) {
        ...
        case 1:
          ...
          } else {// TODO build other combined places
          }
  ...
  arePlaceEquals(p1, p2) {
    return p1.marking === p2.marking && this.isTransitionsEquals(p1, p2, _classes_arc_type__WEBPACK_IMPORTED_MODULE_1__.ArcType.INGOING) && this.isTransitionsEquals(p1, p2, _classes_arc_type__WEBPACK_IMPORTED_MODULE_1__.ArcType.OUTGOING);
  }

  isTransitionsEquals(p1, p2, arcType) {
    ...
    const p2TransToArcs = reduceArcsToMapTransitionKeyArcValue((0,_classes_arc_type__WEBPACK_IMPORTED_MODULE_1__.getArcs)(arcType, p1));
  ...
  static buildCombinedPlace(p1, p2) {
    ...
    for (const activity of relevantActivities) {
      ...
      if (weight > 0) {
        unconnectedIngoingArcs.push(new _classes_template_arc__WEBPACK_IMPORTED_MODULE_4__.TemplateArc(transition, undefined, weight));
      } else if (weight < 0) {
        unconnectedOutgoingArcs.push(new _classes_template_arc__WEBPACK_IMPORTED_MODULE_4__.TemplateArc(undefined, transition, Math.abs(weight)));
      }
    }
...
/***/ 1283:
/*!**********************************************************************************!*\
  !*** ./src/app/classes/algorithms/petri-net/validation/classes/lpo-validator.ts ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LpoValidator": () => (/* binding */ LpoValidator)
/* harmony export */ });
...
class LpoValidator {
  ...
  modifyLPO() {
    ...
    const initial = new _models_partial_order_partial_order_event__WEBPACK_IMPORTED_MODULE_0__.PartialOrderEvent('initial marking', undefined);
    const final = new _models_partial_order_partial_order_event__WEBPACK_IMPORTED_MODULE_0__.PartialOrderEvent('final marking', undefined);
...
/***/ 9245:
/*!*******************************************************************************!*\
  !*** ./src/app/classes/algorithms/petri-net/validation/lpo-fire-validator.ts ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LpoFireValidator": () => (/* binding */ LpoFireValidator)
/* harmony export */ });
...
/* harmony import */ var _lpo_flow_validator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lpo-flow-validator */ 9013);


class LpoFireValidator extends _lpo_flow_validator__WEBPACK_IMPORTED_MODULE_1__.LpoFlowValidator {
  constructor(petriNet, lpo) {
    super(petriNet, lpo);
  ...
  validate() {
    ...
    totalOrder.forEach(e => e.initializeLocalMarking(this._places.length)); // build start event
    ...
    this.fireForwards(queue, validPlaces, complexPlaces); // not valid places
    ...
    const backwardsComplexPlaces = this.newBoolArray(false); // Is the final marking > 0 ?
    ...
    this.fireBackwards(queue, backwardsValidPlaces, backwardsComplexPlaces); // Rest with flow
    ...
    return this._places.map((p, i) => {
      if (validPlaces[i]) {
        ...
        return new _classes_validation_result__WEBPACK_IMPORTED_MODULE_0__.ValidationResult(true, _classes_validation_result__WEBPACK_IMPORTED_MODULE_0__.ValidationPhase.FLOW);
        ...
        return new _classes_validation_result__WEBPACK_IMPORTED_MODULE_0__.ValidationResult(false, _classes_validation_result__WEBPACK_IMPORTED_MODULE_0__.ValidationPhase.FLOW);
      }
    });
  }
...
/***/ 9013:
/*!*******************************************************************************!*\
  !*** ./src/app/classes/algorithms/petri-net/validation/lpo-flow-validator.ts ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LpoFlowValidator": () => (/* binding */ LpoFlowValidator)
/* harmony export */ });
...
/* harmony import */ var _classes_lpo_validator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./classes/lpo-validator */ 1283);
...
class LpoFlowValidator extends _classes_lpo_validator__WEBPACK_IMPORTED_MODULE_1__.LpoValidator {
  constructor(petriNet, lpo) {
    super(petriNet, lpo);
  }
  ...
  validate() {
    ...
    for (let i = 0; i < places.length; i++) {
      ...
      flow[i] = new _classes_validation_result__WEBPACK_IMPORTED_MODULE_2__.ValidationResult(this.checkFlowForPlace(place, events), _classes_validation_result__WEBPACK_IMPORTED_MODULE_2__.ValidationPhase.FLOW);
    }
  ...
  checkFlowForPlace(place, events) {
    ...
    for (let eIndex = 0; eIndex < events.length; eIndex++) {
      network.setUnbounded(LpoFlowValidator.eventStart(eIndex), LpoFlowValidator.eventEnd(eIndex));
      const event = events[eIndex];

      if (event.transition === undefined) {
        if (place.marking > 0) {
          network.setCap(SOURCE, LpoFlowValidator.eventEnd(eIndex), place.marking);
        }
      } else {
        for (const outArc of event.transition.outgoingArcs) {
          ...
          if (postPlace === place) {
            network.setCap(SOURCE, LpoFlowValidator.eventEnd(eIndex), outArc.weight);
          }
        }
        ...
        for (const inArc of event.transition.ingoingArcs) {
          ...
          if (prePlace === place) {
            network.setCap(LpoFlowValidator.eventStart(eIndex), SINK, inArc.weight);
          }
        }
      }

      for (const postEvent of event.nextEvents) {
        network.setUnbounded(LpoFlowValidator.eventEnd(eIndex), LpoFlowValidator.eventStart(events.findIndex(e => e === postEvent)));
      }
    }
...
class PrimitivePlaceGenerator {
  ...
  insertRandomPlace(id, petriNet) {
    const newPlace = new _models_petri_net_place__WEBPACK_IMPORTED_MODULE_0__.Place(Math.random() < 0.5 ? 0 : 1, id); // TODO generate marking

    petriNet.addPlace(newPlace); // TODO aktuell werden "dumm" Transitionen eingefügt die ggf nie genutzt werden aber trotzdem validiert
    ...
    .filter(transition => Math.random() < this._probability).map(transition => Math.random() > 0.5 ? new _models_petri_net_arc__WEBPACK_IMPORTED_MODULE_1__.Arc('i' + id + transition.label, transition, newPlace) : new _models_petri_net_arc__WEBPACK_IMPORTED_MODULE_1__.Arc('o' + id + transition.label, newPlace, transition)).forEach(arc => petriNet.addArc(arc)); // TODO -> Return Template Place
...
/* harmony import */ var _petri_net_validation_lpo_fire_validator__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../petri-net/validation/lpo-fire-validator */ 9245);
/* harmony import */ var _petri_net_transformation_implicit_place_identifier__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../petri-net/transformation/implicit-place-identifier */ 1485);
...
class RstMiner {
  constructor(_minerSettings) {
    ...
    this._concurrencyOracle = _minerSettings.concurrencyOracle.generateConcurrencyOracle(); // TODO DI
  ...
  mine(eventlog) {
    ...
    const implicitPlaceIdentifier = new _petri_net_transformation_implicit_place_identifier__WEBPACK_IMPORTED_MODULE_7__.ImplicitPlaceIdentifier([...allTransitionActivities], partialOrderNetsWithContainedTraces.flatMap(partialOrderNetsWithContainedTraces => partialOrderNetsWithContainedTraces.containedTraces));
    ...
    while (!terminationConditionReachedFct(petriNet)) {
      ...
      const addedPlace = this._randomPlaceGenerator.insertRandomPlace('p' + counterTestedPlaces++, clonedPetriNet); // TODO hauptalgorithmus mit würfeln Testen und optimieren


      const validationResults = partialOrders.flatMap(partialOrder => new _petri_net_validation_lpo_fire_validator__WEBPACK_IMPORTED_MODULE_6__.LpoFireValidator(clonedPetriNet.clone(), partialOrder.clone()).validate()); // TODO -> Achtung verändert

      if (validationResults.filter(validationResult => !validationResult.valid).length >= 1) {
  ...
  removeImplicitPlacesForAndIncreaseCounter(implicitPlaceIdentifier, addedPlace, petriNet, counter) {
    implicitPlaceIdentifier.calculateImplicitPlacesFor(addedPlace, petriNet).filter(implicitResult => RstMiner.checkValidPlaceOrUndefined(implicitResult.substitutePlace)).forEach(implicitResult => {
  ...
  static checkValidPlaceOrUndefined(substitutePlace) {
...
class PetriNetToPartialOrderTransformer {
  transform(net) {
    ...
    const result = new _models_partial_order_partial_order__WEBPACK_IMPORTED_MODULE_0__.PartialOrder();
...
PartialOrderTransformationConfig.DEFAULT_DISCARD_PREFIXES = false; // TODO --> WAS MACHT DAS
...
let PrimitiveGeneratorConfig = PrimitiveGeneratorConfig_1 = class PrimitiveGeneratorConfig extends RandomPlaceGeneratorConfig {
  constructor(probability = PrimitiveGeneratorConfig_1.DEFAULT_PROBABILITY) {
    super();
  ...
  set probability(value) {
    if (value == null || value <= 0 || value >= 1) {
      this._probability = PrimitiveGeneratorConfig_1.DEFAULT_PROBABILITY;
    } else {
  ...
  buildRandomPlaceGenerator() {
    return new _algorithms_rst_miner_generators_primitive_place_generator__WEBPACK_IMPORTED_MODULE_1__.PrimitivePlaceGenerator(this._probability);
  }

};
PrimitiveGeneratorConfig.SIMPLE_NAME = 'Primitive';
PrimitiveGeneratorConfig.DEFAULT_PROBABILITY = 0.5; // TODO

(0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_3__.jsonMember)(Number), (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__metadata)("design:type", Number)], PrimitiveGeneratorConfig.prototype, "_probability", void 0);

PrimitiveGeneratorConfig = PrimitiveGeneratorConfig_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([typedjson__WEBPACK_IMPORTED_MODULE_4__.jsonObject, (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__metadata)("design:paramtypes", [Number])], PrimitiveGeneratorConfig);
...
/* harmony import */ var reflect_metadata__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(reflect_metadata__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var typedjson__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! typedjson */ 382);
/* harmony import */ var typedjson__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! typedjson */ 8825);
...
let RstMinerSettings = class RstMinerSettings {
  constructor(concurrencyOracle = new _concurrency_oracle_config__WEBPACK_IMPORTED_MODULE_2__.NoneOracleConfig(), partialOrderTransformationConfig = new _partial_order_transformation_config__WEBPACK_IMPORTED_MODULE_3__.PartialOrderTransformationConfig(), randomPlaceGenerator = new _random_place_generator_config__WEBPACK_IMPORTED_MODULE_4__.PrimitiveGeneratorConfig(), terminationCondition = new _termination_condition_config__WEBPACK_IMPORTED_MODULE_1__.TimeBasedTerminationConfig(), isDebugModusEnabled = false) {
...
RstMinerSettings.terminationTypesSimpleNames = [_termination_condition_config__WEBPACK_IMPORTED_MODULE_1__.LoopBasedTerminationConfig.SIMPLE_NAME, _termination_condition_config__WEBPACK_IMPORTED_MODULE_1__.TimeBasedTerminationConfig.SIMPLE_NAME];
...
(0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_6__.jsonMember)(_concurrency_oracle_config__WEBPACK_IMPORTED_MODULE_2__.ConcurrencyOracleConfig), (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__metadata)("design:type", _concurrency_oracle_config__WEBPACK_IMPORTED_MODULE_2__.ConcurrencyOracleConfig)], RstMinerSettings.prototype, "concurrencyOracle", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_6__.jsonMember)(_partial_order_transformation_config__WEBPACK_IMPORTED_MODULE_3__.PartialOrderTransformationConfig), (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__metadata)("design:type", _partial_order_transformation_config__WEBPACK_IMPORTED_MODULE_3__.PartialOrderTransformationConfig)], RstMinerSettings.prototype, "partialOrderTransformation", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_6__.jsonMember)(_random_place_generator_config__WEBPACK_IMPORTED_MODULE_4__.RandomPlaceGeneratorConfig), (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__metadata)("design:type", _random_place_generator_config__WEBPACK_IMPORTED_MODULE_4__.RandomPlaceGeneratorConfig)], RstMinerSettings.prototype, "randomPlaceGenerator", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_6__.jsonMember)(_termination_condition_config__WEBPACK_IMPORTED_MODULE_1__.TerminationConditionConfig), (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__metadata)("design:type", _termination_condition_config__WEBPACK_IMPORTED_MODULE_1__.TerminationConditionConfig)], RstMinerSettings.prototype, "terminationCondition", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_6__.jsonMember)(Boolean), (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__metadata)("design:type", Boolean)], RstMinerSettings.prototype, "isDebugModusEnabled", void 0);

RstMinerSettings = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_7__.jsonObject)({
  knownTypes: [_concurrency_oracle_config__WEBPACK_IMPORTED_MODULE_2__.NoneOracleConfig, _concurrency_oracle_config__WEBPACK_IMPORTED_MODULE_2__.AlphaOracleConfig, _concurrency_oracle_config__WEBPACK_IMPORTED_MODULE_2__.TimestampOracleConfig, _random_place_generator_config__WEBPACK_IMPORTED_MODULE_4__.PrimitiveGeneratorConfig, _termination_condition_config__WEBPACK_IMPORTED_MODULE_1__.LoopBasedTerminationConfig, _termination_condition_config__WEBPACK_IMPORTED_MODULE_1__.TimeBasedTerminationConfig]
}), (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__metadata)("design:paramtypes", [_concurrency_oracle_config__WEBPACK_IMPORTED_MODULE_2__.ConcurrencyOracleConfig, _partial_order_transformation_config__WEBPACK_IMPORTED_MODULE_3__.PartialOrderTransformationConfig, _random_place_generator_config__WEBPACK_IMPORTED_MODULE_4__.RandomPlaceGeneratorConfig, _termination_condition_config__WEBPACK_IMPORTED_MODULE_1__.TerminationConditionConfig, Boolean])], RstMinerSettings);
...
var LoopBasedTerminationConfig_1, TimeBasedTerminationConfig_1;
...
LoopBasedTerminationConfig.DEFAULT_ITERATIONS = 1000000;
...
onmessage = function (data) {
  ...
  const resultingPetriNet = new _classes_algorithms_rst_miner_rst_miner__WEBPACK_IMPORTED_MODULE_2__.RstMiner(minerSettings).mine(eventlog);
...
/******/ 			return "" + chunkId + "." + "171ded5bbcccdccf" + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
