...
class PrimitivePlaceGenerator {
  ...
  insertRandomPlace(id, petriNet) {
    ...
    petriNet.addPlace(newPlace); // Array.from(petriNet.getTransitions())
...
class RstMiner {
  ...
  mine(eventlog) {
    ...
    while (!terminationConditionReachedFct(petriNet)) {
      ...
      const addedPlace = this._randomPlaceGenerator.insertRandomPlace('p' + this._counterTestedPlacesLastRun++, clonedPetriNet);
