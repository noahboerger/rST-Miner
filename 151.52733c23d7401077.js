...
var StringAttribute_1, DateAttribute_1, IntAttribute_1, FloatAttribute_1, BooleanAttribute_1;
...
let StringAttribute = StringAttribute_1 = class StringAttribute extends EventlogAttribute {
  ...
  clone() {
    return new StringAttribute_1(this.value, this.key);
  }
...
StringAttribute = StringAttribute_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([typedjson__WEBPACK_IMPORTED_MODULE_3__.jsonObject, (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__metadata)("design:paramtypes", [String, String])], StringAttribute);

let DateAttribute = DateAttribute_1 = class DateAttribute extends EventlogAttribute {
  constructor(value, key) {
    super();
    this.value = value;
    this.key = key;
  ...
  clone() {
    return new DateAttribute_1(this.value, this.key);
  }
...
DateAttribute = DateAttribute_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([typedjson__WEBPACK_IMPORTED_MODULE_3__.jsonObject, (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__metadata)("design:paramtypes", [Date, String])], DateAttribute);

let IntAttribute = IntAttribute_1 = class IntAttribute extends EventlogAttribute {
  constructor(value, key) {
    super();
  ...
  clone() {
    return new IntAttribute_1(this.value, this.key);
  }
...
IntAttribute = IntAttribute_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([typedjson__WEBPACK_IMPORTED_MODULE_3__.jsonObject, (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__metadata)("design:paramtypes", [Number, String])], IntAttribute);

let FloatAttribute = FloatAttribute_1 = class FloatAttribute extends EventlogAttribute {
  constructor(value, key) {
    super();
    this.value = value;
    this.key = key;
  ...
  clone() {
    return new FloatAttribute_1(this.value, this.key);
  }
...
FloatAttribute = FloatAttribute_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([typedjson__WEBPACK_IMPORTED_MODULE_3__.jsonObject, (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__metadata)("design:paramtypes", [Number, String])], FloatAttribute);

let BooleanAttribute = BooleanAttribute_1 = class BooleanAttribute extends EventlogAttribute {
  constructor(value, key) {
    super();
    this.value = value;
    this.key = key;
  ...
  clone() {
    return new BooleanAttribute_1(this.value, this.key);
  }
...
BooleanAttribute = BooleanAttribute_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([typedjson__WEBPACK_IMPORTED_MODULE_3__.jsonObject, (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__metadata)("design:paramtypes", [Boolean, String])], BooleanAttribute);
...
let EventlogEvent = EventlogEvent_1 = class EventlogEvent {
  ...
  clone() {
    return new EventlogEvent_1(this.attributes.map(attribute => attribute.clone()), this.activity, this.lifecycle);
  }
...
EventlogEvent = EventlogEvent_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_6__.jsonObject)({
...
let EventlogTrace = EventlogTrace_1 = class EventlogTrace {
  ...
  clone() {
    return new EventlogTrace_1(this.attributes.map(attribute => attribute.clone()), this.events.map(event => event.clone()), this.caseId);
  }
