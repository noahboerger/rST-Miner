...
/* harmony import */ var _trace_cleaner__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../trace-cleaner */ 3863);
/* harmony import */ var _utility_relabeler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../utility/relabeler */ 2909);
...
class NoneOracle extends _trace_cleaner__WEBPACK_IMPORTED_MODULE_1__.TraceCleaner {
  ...
  determineConcurrency(eventlog) {
    ...
    const cleanedLog = this.cleanLog(eventlogTraces);
    const relabeler = new _utility_relabeler__WEBPACK_IMPORTED_MODULE_2__.Relabeler();
    relabeler.uniquelyRelabelSequences(cleanedLog);
    return _models_concurrency_concurrency_relation__WEBPACK_IMPORTED_MODULE_0__.ConcurrencyRelation.noConcurrency(relabeler);
  }
...
/* harmony import */ var _models_petri_net_transition__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../models/petri-net/transition */ 2986);
...
function reduceArcsToMapActivityKeyArcValue(arcs) {
  return arcs.reduce(function (map, arc) {
    const transition = arc.source instanceof _models_petri_net_transition__WEBPACK_IMPORTED_MODULE_1__.Transition ? arc.source : arc.destination;
    map.set(transition.label, arc);
    return map;
  }, new Map());
}
function buildArc(arcType, relatedPlace, pId, transition, weight) {
  if (arcType === ArcType.INGOING) {
    return new _models_petri_net_arc__WEBPACK_IMPORTED_MODULE_0__.Arc('i' + pId + transition.label, transition, relatedPlace, weight);
  } else {
    return new _models_petri_net_arc__WEBPACK_IMPORTED_MODULE_0__.Arc('o' + pId + transition.label, relatedPlace, transition, weight);
  }
}
...
class TemplateArc {
  ...
  static of(arc) {
    if (arc.source instanceof _models_petri_net_transition__WEBPACK_IMPORTED_MODULE_1__.Transition) {
      return new TemplateArc(arc.source, undefined, arc.weight);
    } else if (arc.destination instanceof _models_petri_net_transition__WEBPACK_IMPORTED_MODULE_1__.Transition) {
...
class TemplatePlace {
  ...
  static of(place) {
    return new TemplatePlace(place.marking, place.ingoingArcs.map(arc => _template_arc__WEBPACK_IMPORTED_MODULE_1__.TemplateArc.of(arc)), place.outgoingArcs.map(arc => _template_arc__WEBPACK_IMPORTED_MODULE_1__.TemplateArc.of(arc)));
  }
  ...
  equalsRegardingMarkingAndSameArcTransitionLabels(other) {
    return this.marking === other.marking && this.isTransitionLabelsEquals(other, _arc_type__WEBPACK_IMPORTED_MODULE_2__.ArcType.INGOING) && this.isTransitionLabelsEquals(other, _arc_type__WEBPACK_IMPORTED_MODULE_2__.ArcType.OUTGOING);
  }

  isTransitionLabelsEquals(other, arcType) {
    function reduceArcsToMapTransitionLabelKeyArcValue(arcs) {
      return arcs.reduce(function (map, arc) {
        const transitionLabel = arc.source instanceof _models_petri_net_transition__WEBPACK_IMPORTED_MODULE_3__.Transition ? arc.source.label : arc.destination.label;
    ...
    const p1TransToArcs = reduceArcsToMapTransitionLabelKeyArcValue((0,_arc_type__WEBPACK_IMPORTED_MODULE_2__.getTemplateArcs)(arcType, this));
    const p2TransToArcs = reduceArcsToMapTransitionLabelKeyArcValue((0,_arc_type__WEBPACK_IMPORTED_MODULE_2__.getTemplateArcs)(arcType, other));
...
/***/ 8175:
/*!**************************************************************************************!*\
  !*** ./src/app/classes/algorithms/rst-miner/generators/geometric-place-generator.ts ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "GeometricPlaceGenerator": () => (/* binding */ GeometricPlaceGenerator)
/* harmony export */ });
/* harmony import */ var _models_petri_net_place__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../models/petri-net/place */ 9973);
/* harmony import */ var _petri_net_transformation_classes_arc_type__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../petri-net/transformation/classes/arc-type */ 2543);


class GeometricPlaceGenerator {
  constructor(_maximalInitialMarking, _geometricIncreaseInitialMarkingProbability, _geometricIncreaseArcsProbability, _maximalIngoingArcWeight, _maximalOutgoingArcWeight) {
    this._maximalInitialMarking = _maximalInitialMarking;
    this._geometricIncreaseInitialMarkingProbability = _geometricIncreaseInitialMarkingProbability;
    this._geometricIncreaseArcsProbability = _geometricIncreaseArcsProbability;
    this._maximalIngoingArcWeight = _maximalIngoingArcWeight;
    this._maximalOutgoingArcWeight = _maximalOutgoingArcWeight;
  }
  ...
  insertRandomPlace(id, petriNet) {
    ...
    const newPlace = new _models_petri_net_place__WEBPACK_IMPORTED_MODULE_0__.Place(initialMarking, id);
    petriNet.addPlace(newPlace);
    this.addGeometricArcs(petriNet, newPlace, id);
    return newPlace;
  }

  addGeometricArcs(petriNet, newPlace, pId) {
    function addRandomArc(arcType) {
      let remainingTransitions;
      let maxWeight;
      let transWeightMap;

      if (arcType === _petri_net_transformation_classes_arc_type__WEBPACK_IMPORTED_MODULE_1__.ArcType.INGOING) {
    ...
    const incomingTransWeightMap = new Map();
    const outgoingTransWeightMap = new Map();
    addRandomArc(_petri_net_transformation_classes_arc_type__WEBPACK_IMPORTED_MODULE_1__.ArcType.INGOING);
    addRandomArc(_petri_net_transformation_classes_arc_type__WEBPACK_IMPORTED_MODULE_1__.ArcType.OUTGOING);
    ...
    incomingTransWeightMap.forEach((weight, transition) => {
      const newArc = (0,_petri_net_transformation_classes_arc_type__WEBPACK_IMPORTED_MODULE_1__.buildArc)(_petri_net_transformation_classes_arc_type__WEBPACK_IMPORTED_MODULE_1__.ArcType.INGOING, newPlace, pId, transition, weight);
      petriNet.addArc(newArc);
    });
    outgoingTransWeightMap.forEach((weight, transition) => {
      const newArc = (0,_petri_net_transformation_classes_arc_type__WEBPACK_IMPORTED_MODULE_1__.buildArc)(_petri_net_transformation_classes_arc_type__WEBPACK_IMPORTED_MODULE_1__.ArcType.OUTGOING, newPlace, pId, transition, weight);
      petriNet.addArc(newArc);
    });
  }
...
/***/ 9346:
/*!******************************************************************!*\
  !*** ./src/app/classes/algorithms/rst-miner/rst-miner-report.ts ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "RstMinerReport": () => (/* binding */ RstMinerReport)
/* harmony export */ });
class RstMinerReport {
  constructor(runtime, totalNumberOfTraces, numberOfTracesAfterNoiseFilter, numberOfPartialOrders, numPlacesTested) {
    this.runtime = runtime;
    this.totalNumberOfTraces = totalNumberOfTraces;
    this.numberOfTracesAfterNoiseFilter = numberOfTracesAfterNoiseFilter;
    this.numberOfPartialOrders = numberOfPartialOrders;
    this.numPlacesTested = numPlacesTested;
  }

  toFormattedString() {
    return '' + '.type result\n' + 'rST miner\n' + '.runtime\n' + this.runtime.milliseconds.toString() + ' ms\n' + '.output\n' + 'total number of traces: ' + this.totalNumberOfTraces.toString() + '\n' + 'number of traces after noise filtering: ' + this.numberOfTracesAfterNoiseFilter.toString() + '\n' + 'number of partial orders: ' + this.numberOfPartialOrders.toString() + '\n' + 'number of places tested: ' + this.numPlacesTested.toString() + '\n' + 'average places tested per second: ' + (this.numPlacesTested / this.runtime.seconds).toFixed(1);
  }
...
/***/ 2577:
/*!******************************************************************!*\
  !*** ./src/app/classes/algorithms/rst-miner/rst-miner-result.ts ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "RstMinerResult": () => (/* binding */ RstMinerResult)
/* harmony export */ });
/* harmony import */ var _rst_miner_report__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./rst-miner-report */ 9346);

class RstMinerResult {
  constructor(petriNet, runtime, totalNumberOfTraces, numTracesAfterNoiseFilter, numPartialOrders, numPlacesTested) {
    this.petriNet = petriNet;
    this.rstMinerReport = new _rst_miner_report__WEBPACK_IMPORTED_MODULE_0__.RstMinerReport(runtime, totalNumberOfTraces, numTracesAfterNoiseFilter, numPartialOrders, numPlacesTested);
  }
...
/* harmony import */ var _rst_miner_result__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./rst-miner-result */ 2577);
/* harmony import */ var ts_duration__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ts-duration */ 3997);
...
class RstMiner {
  ...
  mine(eventlog) {
    ...
    counterTestedPlaces = this._randomPlaceGenerator.init(petriNet, partialOrders);
    ...
    while (!terminationConditionReachedFct(petriNet, counterTestedPlaces)) {
      ...
      if (!this.isGeneratedPlaceValid(addedPlace, clonedPetriNet, lpoFirePlaceValidators, numberOfTracesAfterNoiseFilter)) {
        continue;
      }
      ...
      if (implicitPlaceIdentifier != null) {
        counterTestedPlaces = implicitPlaceIdentifier.removeImplicitPlacesForAndIncreaseCounter(addedPlace, petriNet, counterTestedPlaces);
      }
    }

    return new _rst_miner_result__WEBPACK_IMPORTED_MODULE_8__.RstMinerResult(petriNet, ts_duration__WEBPACK_IMPORTED_MODULE_9__.Duration.since(miningBeginTime), totalNumberOfTraces, numberOfTracesAfterNoiseFilter, partialOrders.length, counterTestedPlaces);
  }
...
class ConcurrencyRelation {
  ...
  static noConcurrency(relabeler = new _utility_relabeler__WEBPACK_IMPORTED_MODULE_0__.Relabeler()) {
...
let NoneOracleConfig = NoneOracleConfig_1 = class NoneOracleConfig extends ConcurrencyOracleConfig {
  constructor(distinguishSameEvents = NoneOracleConfig_1.DEFAULT_DISTINGUISH_SAME_EVENTS) {
    super();
...
NoneOracleConfig.DEFAULT_DISTINGUISH_SAME_EVENTS = false;

(0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_5__.jsonMember)(Boolean), (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__metadata)("design:type", Boolean)], NoneOracleConfig.prototype, "distinguishSameEvents", void 0);

NoneOracleConfig = NoneOracleConfig_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([typedjson__WEBPACK_IMPORTED_MODULE_6__.jsonObject, (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__metadata)("design:paramtypes", [Boolean])], NoneOracleConfig);
...
(0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_5__.jsonMember)(Number), (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__metadata)("design:type", Number)], AlphaOracleConfig.prototype, "_lookAheadDistance", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_5__.jsonMember)(Boolean), (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__metadata)("design:type", Boolean)], AlphaOracleConfig.prototype, "distinguishSameEvents", void 0);

AlphaOracleConfig = AlphaOracleConfig_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([typedjson__WEBPACK_IMPORTED_MODULE_6__.jsonObject, (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__metadata)("design:paramtypes", [Number, Boolean])], AlphaOracleConfig);
...
(0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_5__.jsonMember)(Boolean), (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__metadata)("design:type", Boolean)], TimestampOracleConfig.prototype, "distinguishSameEvents", void 0);

TimestampOracleConfig = TimestampOracleConfig_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([typedjson__WEBPACK_IMPORTED_MODULE_6__.jsonObject, (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__metadata)("design:paramtypes", [Boolean])], TimestampOracleConfig);
...
ImplicitPlaceIdentificationConfig.DEFAULT_IS_VALIDATE_SUBSTITUTE_ARC_WEIGHTS_ENABLED = false;
...
let ProcessModelCharacteristicsConfig = ProcessModelCharacteristicsConfig_1 = class ProcessModelCharacteristicsConfig {
  constructor(placesEmptyAtEnd = ProcessModelCharacteristicsConfig_1.DEFAULT_PLACES_EMPTY_AT_END) {
    this.placesEmptyAtEnd = placesEmptyAtEnd;
  }

};
ProcessModelCharacteristicsConfig.DEFAULT_PLACES_EMPTY_AT_END = true;
...
ProcessModelCharacteristicsConfig = ProcessModelCharacteristicsConfig_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([typedjson__WEBPACK_IMPORTED_MODULE_3__.jsonObject, (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__metadata)("design:paramtypes", [Boolean])], ProcessModelCharacteristicsConfig);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "GeometricDistributionGeneratorConfig": () => (/* binding */ GeometricDistributionGeneratorConfig),
...
/* harmony import */ var reflect_metadata__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! reflect-metadata */ 3037);
/* harmony import */ var reflect_metadata__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(reflect_metadata__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var typedjson__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! typedjson */ 382);
...
/* harmony import */ var _algorithms_rst_miner_generators_geometric_place_generator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../algorithms/rst-miner/generators/geometric-place-generator */ 8175);
var PrimitiveGeneratorConfig_1, GeometricDistributionGeneratorConfig_1;
...
PrimitiveGeneratorConfig.DEFAULT_MAXIMAL_INITIAL_MARKING = 0;
PrimitiveGeneratorConfig.DEFAULT_INGOING_CONNECTION_PROBABILITY = 0.25;
PrimitiveGeneratorConfig.DEFAULT_OUTGOING_CONNECTION_PROBABILITY = 0.25;
...
(0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_4__.jsonMember)(Number), (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__metadata)("design:type", Number)], PrimitiveGeneratorConfig.prototype, "_maximalInitialMarking", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_4__.jsonMember)(Number), (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__metadata)("design:type", Number)], PrimitiveGeneratorConfig.prototype, "_ingoingConnectionProbability", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_4__.jsonMember)(Number), (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__metadata)("design:type", Number)], PrimitiveGeneratorConfig.prototype, "_outgoingConnectionProbability", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_4__.jsonMember)(Number), (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__metadata)("design:type", Number)], PrimitiveGeneratorConfig.prototype, "_maximalIngoingArcWeights", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_4__.jsonMember)(Number), (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__metadata)("design:type", Number)], PrimitiveGeneratorConfig.prototype, "_maximalOutgoingArcWeights", void 0);

PrimitiveGeneratorConfig = PrimitiveGeneratorConfig_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([typedjson__WEBPACK_IMPORTED_MODULE_5__.jsonObject, (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__metadata)("design:paramtypes", [Number, Number, Number, Number, Number])], PrimitiveGeneratorConfig);

let GeometricDistributionGeneratorConfig = GeometricDistributionGeneratorConfig_1 = class GeometricDistributionGeneratorConfig extends RandomPlaceGeneratorConfig {
  constructor(maximalInitialMarking = GeometricDistributionGeneratorConfig_1.DEFAULT_MAXIMAL_INITIAL_MARKING, geometricIncreaseInitialMarkingProbability = GeometricDistributionGeneratorConfig_1.DEFAULT_GEOMETRIC_INCREASE_INITIAL_MARKING_PROBABILITY, geometricIncreaseArcsProbability = GeometricDistributionGeneratorConfig_1.DEFAULT_GEOMETRIC_INCREASE_ARCS_PROBABILITY, maximalIngoingArcWeights = GeometricDistributionGeneratorConfig_1.DEFAULT_MAXIMAL_INGOING_ARC_WEIGHTS, maximalOutgoingArcWeights = GeometricDistributionGeneratorConfig_1.DEFAULT_MAXIMAL_OUTGOING_ARC_WEIGHTS) {
    super();
    this._maximalInitialMarking = maximalInitialMarking;
  ...
  get simpleName() {
    return GeometricDistributionGeneratorConfig_1.SIMPLE_NAME;
  }

  get geometricIncreaseInitialMarkingProbability() {
    return this._geometricIncreaseInitialMarkingProbability;
  }

  set geometricIncreaseInitialMarkingProbability(value) {
    if (value == null || value < 0 || value > 1) {
      this._geometricIncreaseInitialMarkingProbability = GeometricDistributionGeneratorConfig_1.DEFAULT_GEOMETRIC_INCREASE_INITIAL_MARKING_PROBABILITY;
    } else {
      this._geometricIncreaseInitialMarkingProbability = value;
    }
  }

  get geometricIncreaseArcsProbability() {
    return this._geometricIncreaseArcsProbability;
  }

  set geometricIncreaseArcsProbability(value) {
    if (value == null || value < 0 || value > 1) {
      this._geometricIncreaseArcsProbability = GeometricDistributionGeneratorConfig_1.DEFAULT_GEOMETRIC_INCREASE_ARCS_PROBABILITY;
    } else {
  ...
  set maximalInitialMarking(value) {
    if (value == null || value < 0 || value > 100) {
      this._maximalInitialMarking = GeometricDistributionGeneratorConfig_1.DEFAULT_MAXIMAL_INITIAL_MARKING;
    } else {
      this._maximalInitialMarking = value;
    }
  }
  ...
  set maximalIngoingArcWeights(value) {
    if (value == null || value < 1 || value > 100) {
      this._maximalIngoingArcWeights = GeometricDistributionGeneratorConfig_1.DEFAULT_MAXIMAL_INGOING_ARC_WEIGHTS;
    } else {
      this._maximalIngoingArcWeights = value;
    }
  }
  ...
  set maximalOutgoingArcWeights(value) {
    if (value == null || value < 1 || value > 100) {
      this._maximalOutgoingArcWeights = GeometricDistributionGeneratorConfig_1.DEFAULT_MAXIMAL_OUTGOING_ARC_WEIGHTS;
    } else {
      this._maximalOutgoingArcWeights = value;
    }
  }
  ...
  buildRandomPlaceGenerator() {
    return new _algorithms_rst_miner_generators_geometric_place_generator__WEBPACK_IMPORTED_MODULE_2__.GeometricPlaceGenerator(this._maximalInitialMarking, this._geometricIncreaseInitialMarkingProbability, this._geometricIncreaseArcsProbability, this._maximalIngoingArcWeights, this._maximalOutgoingArcWeights);
  }

};
GeometricDistributionGeneratorConfig.SIMPLE_NAME = 'Geometric Distribution';
GeometricDistributionGeneratorConfig.DEFAULT_MAXIMAL_INITIAL_MARKING = 0;
GeometricDistributionGeneratorConfig.DEFAULT_GEOMETRIC_INCREASE_INITIAL_MARKING_PROBABILITY = 0.5;
GeometricDistributionGeneratorConfig.DEFAULT_GEOMETRIC_INCREASE_ARCS_PROBABILITY = 0.65;
GeometricDistributionGeneratorConfig.DEFAULT_MAXIMAL_INGOING_ARC_WEIGHTS = 1;
GeometricDistributionGeneratorConfig.DEFAULT_MAXIMAL_OUTGOING_ARC_WEIGHTS = 1;

(0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_4__.jsonMember)(Number), (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__metadata)("design:type", Number)], GeometricDistributionGeneratorConfig.prototype, "_maximalInitialMarking", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_4__.jsonMember)(Number), (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__metadata)("design:type", Number)], GeometricDistributionGeneratorConfig.prototype, "_geometricIncreaseInitialMarkingProbability", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_4__.jsonMember)(Number), (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__metadata)("design:type", Number)], GeometricDistributionGeneratorConfig.prototype, "_geometricIncreaseArcsProbability", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_4__.jsonMember)(Number), (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__metadata)("design:type", Number)], GeometricDistributionGeneratorConfig.prototype, "_maximalIngoingArcWeights", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_4__.jsonMember)(Number), (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__metadata)("design:type", Number)], GeometricDistributionGeneratorConfig.prototype, "_maximalOutgoingArcWeights", void 0);

GeometricDistributionGeneratorConfig = GeometricDistributionGeneratorConfig_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([typedjson__WEBPACK_IMPORTED_MODULE_5__.jsonObject, (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__metadata)("design:paramtypes", [Number, Number, Number, Number, Number])], GeometricDistributionGeneratorConfig);
...
let RstMinerSettings = RstMinerSettings_1 = class RstMinerSettings {
  constructor(processModelCharacteristics = new _process_model_characteristics_config__WEBPACK_IMPORTED_MODULE_7__.ProcessModelCharacteristicsConfig(), noiseReduction = new _noise_reduction_config__WEBPACK_IMPORTED_MODULE_6__.PreprocessingNoiseReductionConfig(), concurrencyOracle = new _concurrency_oracle_config__WEBPACK_IMPORTED_MODULE_2__.TimestampOracleConfig(), partialOrderTransformationConfig = new _partial_order_transformation_config__WEBPACK_IMPORTED_MODULE_3__.PartialOrderTransformationConfig(), randomPlaceGenerator = new _random_place_generator_config__WEBPACK_IMPORTED_MODULE_4__.GeometricDistributionGeneratorConfig(), terminationCondition = new _termination_condition_config__WEBPACK_IMPORTED_MODULE_1__.TimeBasedTerminationConfig(), implicitPlaceIdentification = new _implicit_place_identification_config__WEBPACK_IMPORTED_MODULE_5__.ImplicitPlaceIdentificationConfig(), isDebugModusEnabled = RstMinerSettings_1.DEFAULT_DEBUG_MODUS_ENABLED, isDownloadPetriNetEnabled = RstMinerSettings_1.DEFAULT_DOWNLOAD_PETRI_NET_ENABLED, isDownloadReportEnabled = RstMinerSettings_1.DEFAULT_DOWNLOAD_REPORT_ENABLED) {
...
RstMinerSettings.DEFAULT_DOWNLOAD_PETRI_NET_ENABLED = true;
RstMinerSettings.DEFAULT_DOWNLOAD_REPORT_ENABLED = false;
...
RstMinerSettings.randomPlaceGeneratorTypesSimpleNames = [_random_place_generator_config__WEBPACK_IMPORTED_MODULE_4__.PrimitiveGeneratorConfig.SIMPLE_NAME, _random_place_generator_config__WEBPACK_IMPORTED_MODULE_4__.GeometricDistributionGeneratorConfig.SIMPLE_NAME];
...
(0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_9__.jsonMember)(Boolean), (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__metadata)("design:type", Boolean)], RstMinerSettings.prototype, "isDownloadPetriNetEnabled", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_9__.jsonMember)(Boolean), (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__metadata)("design:type", Boolean)], RstMinerSettings.prototype, "isDownloadReportEnabled", void 0);
...
/***/ 7402:
/*!***************************************************************************************************!*\
  !*** ./src/app/classes/models/miner-settings/standard-pm-nets/standard-process-model-net-type.ts ***!
  \***************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "StandardProcessModelNetType": () => (/* binding */ StandardProcessModelNetType),
/* harmony export */   "allStandardProcessModelNetTypeEnumValues": () => (/* binding */ allStandardProcessModelNetTypeEnumValues),
/* harmony export */   "fromString": () => (/* binding */ fromString),
/* harmony export */   "getKnowPetriNetString": () => (/* binding */ getKnowPetriNetString),
/* harmony export */   "getStandardModelFromNetString": () => (/* binding */ getStandardModelFromNetString),
/* harmony export */   "toString": () => (/* binding */ toString)
/* harmony export */ });
var StandardProcessModelNetType = /*#__PURE__*/(() => {
  (function (StandardProcessModelNetType) {
    StandardProcessModelNetType[StandardProcessModelNetType["REPAIR_EXAMPLE"] = 0] = "REPAIR_EXAMPLE";
    StandardProcessModelNetType[StandardProcessModelNetType["USER_DEFINED"] = 1] = "USER_DEFINED";
    StandardProcessModelNetType[StandardProcessModelNetType["REVIEWING_EXAMPLE"] = 2] = "REVIEWING_EXAMPLE";
  })(StandardProcessModelNetType || (StandardProcessModelNetType = {}));

  return StandardProcessModelNetType;
})();
const REPAIR_EXAMPLE_NET_STRING = '.type pn\n' + '.transitions\n' + 'Register Register\n' + 'AnalyzeDefect AnalyzeDefect\n' + 'InformUser InformUser\n' + 'RepairComplex RepairComplex\n' + 'TestRepair TestRepair\n' + 'ArchiveRepair ArchiveRepair\n' + 'RepairSimple RepairSimple\n' + 'RestartRepair RestartRepair\n' + '.places\n' + 'p0 0\n' + 'p1 0\n' + 'p2 0\n' + 'p3 0\n' + 'p4 0\n' + 'p5 0\n' + '.arcs\n' + 'InformUser p0\n' + 'p0 ArchiveRepair\n' + 'AnalyzeDefect p1\n' + 'p1 InformUser\n' + 'Register p2\n' + 'p2 AnalyzeDefect\n' + 'TestRepair p3\n' + 'p3 ArchiveRepair\n' + 'p3 RestartRepair\n' + 'RepairComplex p4\n' + 'RepairSimple p4\n' + 'p4 TestRepair\n' + 'AnalyzeDefect p5\n' + 'RestartRepair p5\n' + 'p5 RepairComplex\n' + 'p5 RepairSimple';
const REVIEWING_EXAMPLE_NET_STRING = '.type.pn\n' + '.places\n' + 'p1 0\n' + 'p2 0\n' + 'p3 0\n' + 'p4 0\n' + 'p5 0\n' + 'p6 0\n' + 'p7 0\n' + 'p8 0\n' + 'p9 0\n' + '.transitions\n' + 'inviteReviewers inviteReviewers\n' + 'getReview1 getReview1\n' + 'getReview2 getReview2\n' + 'getReview3 getReview3\n' + 'timeOut1 timeOut1\n' + 'timeOut2 timeOut2\n' + 'timeOut3 timeOut3\n' + 'collectReviews collectReviews\n' + 'decide decide\n' + 'inviteAdditionalReviewer inviteAdditionalReviewer\n' + 'timeOutX timeOutX\n' + 'getReviewX getReviewX\n' + 'accept accept\n' + 'reject reject\n' + '.arcs\n' + 'inviteReviewers p1\n' + 'p1 getReview1\n' + 'p1 timeOut1\n' + 'inviteReviewers p2\n' + 'p2 timeOut2\n' + 'p2 getReview2\n' + 'inviteReviewers p3\n' + 'p3 getReview3\n' + 'p3 timeOut3\n' + 'timeOut1 p4\n' + 'getReview1 p4\n' + 'p4 collectReviews\n' + 'getReview2 p5\n' + 'timeOut2 p5\n' + 'p5 collectReviews\n' + 'timeOut3 p6\n' + 'getReview3 p6\n' + 'p6 collectReviews\n' + 'collectReviews p7\n' + 'getReviewX p7\n' + 'timeOutX p7\n' + 'p7 decide\n' + 'inviteAdditionalReviewer p8\n' + 'p8 getReviewX\n' + 'p8 timeOutX\n' + 'decide p9\n' + 'p9 accept\n' + 'p9 inviteAdditionalReviewer\n' + 'p9 reject';
const EMPTY_USER_DEFINED_NET = '.type pn\n' + '.transitions\n' + '.places\n' + '.arcs';
function allStandardProcessModelNetTypeEnumValues() {
  return Object.values(StandardProcessModelNetType).filter(v => isNaN(Number(v))).map(v => StandardProcessModelNetType[v]);
}
function toString(standardProcessModelNet) {
...
function getKnowPetriNetString(standardProcessModelNet) {
  switch (standardProcessModelNet) {
    case StandardProcessModelNetType.REPAIR_EXAMPLE:
...
function getStandardModelFromNetString(netString) {
  switch (netString) {
...
/* harmony export */   "PetriNetStateReachedTerminationConfig": () => (/* binding */ PetriNetStateReachedTerminationConfig),
...
/* harmony export */   "isSameState": () => (/* binding */ isSameState)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tslib */ 655);
/* harmony import */ var reflect_metadata__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! reflect-metadata */ 3037);
/* harmony import */ var reflect_metadata__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(reflect_metadata__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var typedjson__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! typedjson */ 382);
/* harmony import */ var typedjson__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! typedjson */ 8825);
/* harmony import */ var ts_duration__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ts-duration */ 3997);
/* harmony import */ var _parser_petri_net_petri_net_parser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../parser/petri-net/petri-net-parser */ 6708);
/* harmony import */ var _algorithms_petri_net_transformation_classes_template_place__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../algorithms/petri-net/transformation/classes/template-place */ 9605);
/* harmony import */ var _standard_pm_nets_standard_process_model_net_type__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./standard-pm-nets/standard-process-model-net-type */ 7402);
/* harmony import */ var _algorithms_rst_miner_rst_miner__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../algorithms/rst-miner/rst-miner */ 5091);
var LoopBasedTerminationConfig_1, EvaluatedPlacesTerminationConfig_1, TimeBasedTerminationConfig_1, PetriNetStateReachedTerminationConfig_1;
...
TerminationConditionConfig.DEFAULT_NO_CHANGE_SINCE_ENABLED = true;

(0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_7__.jsonMember)(Boolean), (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__metadata)("design:type", Boolean)], TerminationConditionConfig.prototype, "_noChangeSinceEnabled", void 0);
...
(0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_7__.jsonMember)(Number), (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__metadata)("design:type", Number)], LoopBasedTerminationConfig.prototype, "_loopAmount", void 0);

LoopBasedTerminationConfig = LoopBasedTerminationConfig_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([typedjson__WEBPACK_IMPORTED_MODULE_8__.jsonObject, (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__metadata)("design:paramtypes", [Number])], LoopBasedTerminationConfig);
...
EvaluatedPlacesTerminationConfig.DEFAULT_AMOUNT_EVALUATED_OF_PLACES = 50000;

(0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_7__.jsonMember)(Number), (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__metadata)("design:type", Number)], EvaluatedPlacesTerminationConfig.prototype, "_amountOfEvaluatedPlaces", void 0);

EvaluatedPlacesTerminationConfig = EvaluatedPlacesTerminationConfig_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([typedjson__WEBPACK_IMPORTED_MODULE_8__.jsonObject, (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__metadata)("design:paramtypes", [Number])], EvaluatedPlacesTerminationConfig);
...
TimeBasedTerminationConfig.DEFAULT_DURATION = ts_duration__WEBPACK_IMPORTED_MODULE_1__.Duration.second(1);
...
(0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_7__.jsonMember)(Number), (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__metadata)("design:type", Number)], TimeBasedTerminationConfig.prototype, "_durationInMs", void 0);

TimeBasedTerminationConfig = TimeBasedTerminationConfig_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([typedjson__WEBPACK_IMPORTED_MODULE_8__.jsonObject, (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__metadata)("design:paramtypes", [ts_duration__WEBPACK_IMPORTED_MODULE_1__.Duration])], TimeBasedTerminationConfig);

let PetriNetStateReachedTerminationConfig = PetriNetStateReachedTerminationConfig_1 = class PetriNetStateReachedTerminationConfig extends TerminationConditionConfig {
  constructor(petriNetStringRepresentation = PetriNetStateReachedTerminationConfig_1.DEFAULT_PETRI_NET_STRING_REPRESENTATION) {
    super();
    this.netParser = new _parser_petri_net_petri_net_parser__WEBPACK_IMPORTED_MODULE_2__.PetriNetParser();
    this._petriNetStringRepresentation = petriNetStringRepresentation;
  }

  get simpleName() {
    return PetriNetStateReachedTerminationConfig_1.SIMPLE_NAME;
  }

  get petriNetStringRepresentation() {
    return this._petriNetStringRepresentation;
  }

  set petriNetStringRepresentation(value) {
    this._petriNetStringRepresentation = value;
  }

  get standardProcessModelNetType() {
    return (0,_standard_pm_nets_standard_process_model_net_type__WEBPACK_IMPORTED_MODULE_4__.getStandardModelFromNetString)(this._petriNetStringRepresentation);
  }

  set standardProcessModelNetType(value) {
    const actType = (0,_standard_pm_nets_standard_process_model_net_type__WEBPACK_IMPORTED_MODULE_4__.getStandardModelFromNetString)(this._petriNetStringRepresentation); // keep user input

    if (value === _standard_pm_nets_standard_process_model_net_type__WEBPACK_IMPORTED_MODULE_4__.StandardProcessModelNetType.USER_DEFINED && actType === _standard_pm_nets_standard_process_model_net_type__WEBPACK_IMPORTED_MODULE_4__.StandardProcessModelNetType.USER_DEFINED) {
      return;
    }

    this._petriNetStringRepresentation = (0,_standard_pm_nets_standard_process_model_net_type__WEBPACK_IMPORTED_MODULE_4__.getKnowPetriNetString)(value);
  }

  toIsTerminationConditionReachedFunction() {
    const toBeReachedNet = this.netParser.parse(this._petriNetStringRepresentation); // parsing failure

    if (toBeReachedNet == null) {
      throw _algorithms_rst_miner_rst_miner__WEBPACK_IMPORTED_MODULE_5__.RstMiner.MINING_ERROR;
    }

    const toBeReachedTemplatePlaces = toBeReachedNet.getPlaces().map(place => _algorithms_petri_net_transformation_classes_template_place__WEBPACK_IMPORTED_MODULE_3__.TemplatePlace.of(place));
    return function (actState, numPlacesEvaluated) {
...
PetriNetStateReachedTerminationConfig.SIMPLE_NAME = 'PetriNet State Reached';
PetriNetStateReachedTerminationConfig.DEFAULT_PETRI_NET_STRING_REPRESENTATION = (0,_standard_pm_nets_standard_process_model_net_type__WEBPACK_IMPORTED_MODULE_4__.getKnowPetriNetString)(_standard_pm_nets_standard_process_model_net_type__WEBPACK_IMPORTED_MODULE_4__.StandardProcessModelNetType.REPAIR_EXAMPLE);

(0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_7__.jsonMember)(String), (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__metadata)("design:type", String)], PetriNetStateReachedTerminationConfig.prototype, "_petriNetStringRepresentation", void 0);

PetriNetStateReachedTerminationConfig = PetriNetStateReachedTerminationConfig_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([typedjson__WEBPACK_IMPORTED_MODULE_8__.jsonObject, (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__metadata)("design:paramtypes", [String])], PetriNetStateReachedTerminationConfig);

function isSameState(actState, toBeReachedNet, toBeReachedTemplatePlaces) {
  if (actState.getArcCount() < toBeReachedNet.getArcCount() || actState.getPlaceCount() < toBeReachedNet.getPlaceCount()) {
    return false;
  }

  const existingTemplatePlaces = actState.getPlaces().map(place => _algorithms_petri_net_transformation_classes_template_place__WEBPACK_IMPORTED_MODULE_3__.TemplatePlace.of(place));
...
/***/ 9388:
/*!******************************************************************!*\
  !*** ./src/app/classes/models/utils/serializable-string-pair.ts ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SerializableStringPair": () => (/* binding */ SerializableStringPair)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ 655);
/* harmony import */ var typedjson__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! typedjson */ 382);
/* harmony import */ var typedjson__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! typedjson */ 8825);


let SerializableStringPair = class SerializableStringPair {
...
(0,tslib__WEBPACK_IMPORTED_MODULE_0__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_1__.jsonMember)(String), (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__metadata)("design:type", String)], SerializableStringPair.prototype, "left", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_0__.__decorate)([(0,typedjson__WEBPACK_IMPORTED_MODULE_1__.jsonMember)(String), (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__metadata)("design:type", String)], SerializableStringPair.prototype, "right", void 0);

SerializableStringPair = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__decorate)([typedjson__WEBPACK_IMPORTED_MODULE_2__.jsonObject, (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__metadata)("design:paramtypes", [String, String])], SerializableStringPair);
...
/***/ 6708:
/*!**************************************************************!*\
  !*** ./src/app/classes/parser/petri-net/petri-net-parser.ts ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PetriNetParser": () => (/* binding */ PetriNetParser)
/* harmony export */ });
/* harmony import */ var _models_petri_net_petri_net__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../models/petri-net/petri-net */ 1509);
/* harmony import */ var _serde_block_type__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../serde/block-type */ 2017);
/* harmony import */ var _utility_abstract_block_parser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../utility/abstract-block-parser */ 3989);
/* harmony import */ var _models_petri_net_transition__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../models/petri-net/transition */ 2986);
/* harmony import */ var _models_petri_net_place__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../models/petri-net/place */ 9973);
/* harmony import */ var _models_petri_net_arc__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../models/petri-net/arc */ 6781);
...
class PetriNetParser extends _utility_abstract_block_parser__WEBPACK_IMPORTED_MODULE_2__.AbstractBlockParser {
  constructor() {
    super('pn', [_serde_block_type__WEBPACK_IMPORTED_MODULE_1__.BlockType.PLACES, _serde_block_type__WEBPACK_IMPORTED_MODULE_1__.BlockType.TRANSITIONS, _serde_block_type__WEBPACK_IMPORTED_MODULE_1__.BlockType.ARCS]);
  }

  newResult() {
    return new _models_petri_net_petri_net__WEBPACK_IMPORTED_MODULE_0__.PetriNet();
  }

  resolveBlockParser(block) {
    switch (block) {
      case _serde_block_type__WEBPACK_IMPORTED_MODULE_1__.BlockType.PLACES:
        return (lines, result) => this.parsePlaces(lines, result);

      case _serde_block_type__WEBPACK_IMPORTED_MODULE_1__.BlockType.TRANSITIONS:
        return (lines, result) => this.parseTransitions(lines, result);

      case _serde_block_type__WEBPACK_IMPORTED_MODULE_1__.BlockType.ARCS:
  ...
  parsePlaces(lines, net) {
    this.parseEachLine(lines, (parts, line) => {
      ...
      const place = new _models_petri_net_place__WEBPACK_IMPORTED_MODULE_4__.Place(initialMarking, parts[0]);
      net.addPlace(place);
    });
  }
  ...
  parseTransitions(lines, net) {
    this.parseEachLine(lines, (parts, line) => {
      ...
      net.addTransition(new _models_petri_net_transition__WEBPACK_IMPORTED_MODULE_3__.Transition(parts[1], parts[0]));
    });
  }
  ...
  parseArcs(lines, net) {
    this.parseEachLine(lines, (parts, line) => {
      ...
      const arc = new _models_petri_net_arc__WEBPACK_IMPORTED_MODULE_5__.Arc(arcId, srcDest.source, srcDest.destination, weight);
      net.addArc(arc);
    });
  }

  static extractSourceAndDestination(sourceId, destinationId, line, net) {
...
/***/ 3989:
/*!**********************************************************!*\
  !*** ./src/app/classes/utility/abstract-block-parser.ts ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AbstractBlockParser": () => (/* binding */ AbstractBlockParser)
/* harmony export */ });
/* harmony import */ var _abstract_parser__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-parser */ 2292);

class AbstractBlockParser extends _abstract_parser__WEBPACK_IMPORTED_MODULE_0__.AbstractParser {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var typedjson__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! typedjson */ 6283);
...
/* harmony import */ var _classes_models_utils_serializable_string_pair__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../classes/models/utils/serializable-string-pair */ 9388);
...
onmessage = function (data) {
  const minerSettings = new typedjson__WEBPACK_IMPORTED_MODULE_5__.TypedJSON(_classes_models_miner_settings_rst_miner_settings__WEBPACK_IMPORTED_MODULE_1__.RstMinerSettings).parse(data.data[0]);
  const eventlog = new typedjson__WEBPACK_IMPORTED_MODULE_5__.TypedJSON(_classes_models_eventlog_eventlog__WEBPACK_IMPORTED_MODULE_0__.Eventlog).parse(data.data[1]);
  ...
  const petriNetString = (0,_classes_serde_petri_net_serialisation__WEBPACK_IMPORTED_MODULE_3__.serialisePetriNet)(rstMinerResult.petriNet);
  const reportString = rstMinerResult.rstMinerReport.toFormattedString();
  const serialisedResultPair = new typedjson__WEBPACK_IMPORTED_MODULE_5__.TypedJSON(_classes_models_utils_serializable_string_pair__WEBPACK_IMPORTED_MODULE_4__.SerializableStringPair).stringify(new _classes_models_utils_serializable_string_pair__WEBPACK_IMPORTED_MODULE_4__.SerializableStringPair(petriNetString, reportString));
