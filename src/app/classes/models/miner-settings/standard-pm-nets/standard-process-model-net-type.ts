...
export function allStandardProcessModelNetTypeEnumValues(): Array<StandardProcessModelNetType> {
    return Object.values(StandardProcessModelNetType).filter((v) => isNaN(Number(v))).map(v => (<any>StandardProcessModelNetType)[v])
}

export function toString(standardProcessModelNet: StandardProcessModelNetType): string {
...
export function getKnowPetriNetString(standardProcessModelNet: StandardProcessModelNetType): string {
    switch (standardProcessModelNet) {
        case StandardProcessModelNetType.REPAIR_EXAMPLE:
...
export function getStandardModelFromNetString(netString: string): StandardProcessModelNetType {
    switch (netString) {
