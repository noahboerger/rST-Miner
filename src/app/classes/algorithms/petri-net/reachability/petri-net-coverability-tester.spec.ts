...
import {PetriNetCoverabilityTester} from "./petri-net-coverability-tester";
...
describe('PetriNetCoverabilityService', () => {
    let coverabilityTester: PetriNetCoverabilityTester;
    let petriNetParser: PetriNetParser;

    beforeEach(() => {
        TestBed.configureTestingModule({});
        coverabilityTester = new PetriNetCoverabilityTester();
        petriNetParser = new PetriNetParser();
    });

    it('should be created', () => {
        expect(coverabilityTester).toBeTruthy();
    });

    it('should do conflict', () => {
        const net = petriNetParser.parse(`.type pn
.transitions
A A
B B
.places
...
B b`);
        ...
        const tree = coverabilityTester.getCoverabilityTree(net!);
