...
import {ImplicitPlaceRemover} from './implicit-place-remover';
...
describe('ImplicitPlaceRemoverService', () => {
    let service: ImplicitPlaceRemover;
    let netParser: PetriNetParser;

    beforeEach(() => {
        TestBed.configureTestingModule({});
        service = new ImplicitPlaceRemover(new PetriNetCoverabilityTester());
