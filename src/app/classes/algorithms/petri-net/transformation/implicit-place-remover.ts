import {LogCleaner} from "../../concurrency-oracle/log-cleaner";
import {PetriNetCoverabilityTester} from "../reachability/petri-net-coverability-tester";
import {PetriNet} from "../../../models/petri-net/petri-net";
import {Marking} from "../../../models/petri-net/marking";


export class ImplicitPlaceRemover extends LogCleaner {

    constructor(protected _coverabilityTreeService: PetriNetCoverabilityTester) {
        super();
    }
