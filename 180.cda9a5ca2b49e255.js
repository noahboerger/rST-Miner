...
class RstMiner {
  ...
  removeImplicitPlacesForAndIncreaseCounter(implicitPlaceIdentifier, addedPlace, petriNet, counter) {
    implicitPlaceIdentifier.calculateImplicitPlacesFor(addedPlace, petriNet).filter(implicitResult => RstMiner.checkSubstitutePlacesAreValidOrUndefined(implicitResult.substitutePlaces)).forEach(implicitResult => {
  ...
  static checkSubstitutePlacesAreValidOrUndefined( // TODO ggf direkt im rST-Miner zur teilevaluation
  substitutePlaces) {
