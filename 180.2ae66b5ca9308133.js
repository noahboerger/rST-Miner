  ...
  mine(eventlog) {
    ...
    while (!terminationConditionReachedFct(petriNet)) {
      ...
      if (implicitPlaceIdentifier != null) {
        this._counterTestedPlacesLastRun = implicitPlaceIdentifier.removeImplicitPlacesForAndIncreaseCounter(addedPlace, petriNet, this._counterTestedPlacesLastRun);
      }
    }
...
PartialOrderTransformationConfig.DEFAULT_DISCARD_PREFIXES = false;
