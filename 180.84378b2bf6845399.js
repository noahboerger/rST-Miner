...
class RstMinerReport {
  constructor(runtime, numberOfTraces, numberOfPartialOrders, numPlacesTested) {
...
class RstMinerResult {
  constructor(petriNet, runtime, numTraces, numPartialOrders, numPlacesTested) {
    this.petriNet = petriNet;
    this.rstMinerReport = new _rst_miner_report__WEBPACK_IMPORTED_MODULE_0__.RstMinerReport(runtime, numTraces, numPartialOrders, numPlacesTested);
  }
...
class RstMiner {
  ...
  mine(eventlog) {
    ...
    return new _rst_miner_result__WEBPACK_IMPORTED_MODULE_8__.RstMinerResult(petriNet, ts_duration__WEBPACK_IMPORTED_MODULE_9__.Duration.since(miningBeginTime), totalTraces, partialOrders.length, counterTestedPlaces);
  }
